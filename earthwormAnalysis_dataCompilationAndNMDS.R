...
wormData<-read.csv(".\\dataForR\\earthwormData.csv")

#functional group look-up table, derived from master sheet from Erin, February 2018
fxnLUT<-read.csv(".\\dataForR\\fxnlGroupByCode.csv")

#plants from Erin - christine cleaned up by removing canopy trees
allPlants<-read.csv(".\\dataForR\\allCommunity_canopyRemoved_Feb2018.csv")
names(allPlants)

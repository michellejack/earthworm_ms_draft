...
shandiv<-lm(shannon~mass+site+Treatment,data=everything)
...
shandiv2<-lm(shannon~site+Treatment*mass, data=everything)
...
shandiv3<-lm(shannon~site+mass, data=everything[everything$Treatment=="Eradicated",])
